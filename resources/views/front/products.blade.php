  ...
  <!--======================CONTENT===================-->
    <main class="page-content">
      <section class="well well-7 bg-alabster"
        style="background-image: url(front/images/Vector.svg);background-repeat: no-repeat;">
        <div class="container-fluid">
          <div class="row text-center text-md-left">
            <div class="col-md-6 order-md-2">
              <div class="image-wrap image-wrap-left image-wrap-left-md image-wrap-3">
                <img src="{{asset('front/images/Group 339.svg')}}" width="600" height="700" alt="">
              </div>
            </div>
          ...
          <div class="row gy-4 gy-lg-0 justify-content-xl-between">
            ...
            <div class="col-12 col-md-4 col-lg-4 col-xl-2">
              <div class="widget1">
                ...
                <p class="mb-0">
                  <a class="link-secondary text-decoration-none"
                    href="https://enopeckects.com">https://enopeckects.com</a>
                </p>
              </div>
            </div>
            <div class="col-12 col-md-4 col-lg-3 col-xl-2">
