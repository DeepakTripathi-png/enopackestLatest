      ...
      <div class="container text-center">
        <div class="row text-md-left">
          ...
          <div class="col-md-4 col-lg-6">
              ...
              <p>
               Enopeck Seals Industries offers a
                ...
                your logistics with Enopeck Seals Industries.
              </p>
          </div>
           <div class="col-md-6">
            <div class="solution1">
              <div class="image-wrap image-wrap-left image-wrap-left-md image-wrap-3">
                <img src="{{asset('front/images/Group 339.svg')}}" width="650" height="600" alt="solution">
              </div>
            </div>
          </div>
        </div>
